 ...
 */
	public function field($key = '', $value = null, $id = null, $options = array()) {
		...
		if ($inputClass) {
            $_options['key']['class'] = $inputClass;
            $_options['value']['class'] .= ' ' . $inputClass;
		}
    ...
    public function field2($key = '', $value = null, $id = null, $options = array(),$withId = true) {
        $inputClass = $this->Layout->cssClass('formInput');
        $_options = array(
            'key' => array(
                'label' => __d('croogo', 'Key'),
        ...
        $deleteUrl = $this->settings['deleteUrl'];
        $deleteUrl[] = $id;
        $output = $this->Html->tag('div',$fields, array('class' => 'meta'));
        return $output;
    }
}
